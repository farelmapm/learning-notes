# Introduction to Active Directory Enumeration and Attacks

## Active Directory Explained
Active Directory (AD) is a directory service for Windows enterprise environments. 

## Connecting via FreeRDP
```
farelmusyaffa@htb[/htb]$ xfreerdp /v:<MS01 target IP> /u:htb-student /p:Academy_student_AD!
```

## Connecting via SSH
```
farelmusyaffa@htb[/htb]$ ssh htb-student@<ATTACK01 target IP>
```
